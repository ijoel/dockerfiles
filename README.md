**NOTE**: Archived repo 2026/07/28

An ~~assorted~~ ~~shrinking~~ old (thanks, NixOS!) collection of Dockerfiles,
mostly designed for home server/lab use. Build/run instructions are in each
